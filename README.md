...
See the [changelog](changelog.md) for the current features and future development/release plans for the ATS & ETS development and the [INSPIRE Reference Validator](http://inspire-sandbox.jrc.ec.europa.eu/validator/).
